...
public class MQClientAPIImpl {
    ...
    /***
     *  查询broker中的producergroup 信息
     *
     * **/
    public List<String> getAllProducerGroupByBroker(final String addr, long timeoutMillis) throws RemotingConnectException,
            RemotingSendRequestException, RemotingTimeoutException, InterruptedException, MQBrokerException {
        RemotingCommand request = RemotingCommand.createRequestCommand(RequestCode.GET_PRODUCER_GROUP_LIST, null);
        ...
        switch (response.getCode()) {
            case ResponseCode.SUCCESS: {
                if (response.getBody() != null) {
                    GetProducerGroupResponseBody body =
                            GetProducerGroupResponseBody.decode(response.getBody(), GetProducerGroupResponseBody.class);
                    List<String> list = new ArrayList(body.getConsumerIdList());
                    return list;
                }
            }
            default:
